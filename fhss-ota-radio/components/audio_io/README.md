...
- `AUDIO_IO_SPK_*_GPIO` (BCLK/WS/DOUT/GAIN/SD) — MAX98357A, 현재 GPIO15/16/17/18/11 (ESP32-S3-DevKitC-1 J1 헤더 기준, BCLK~GAIN은 물리적으로 연속. SD는 GPIO8(로터리)/GPIO3·46(스트래핑, 사용 금지)을 건너뛰고 배정)
